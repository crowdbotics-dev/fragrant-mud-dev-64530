"""
Django settings for fragrant_mud_dev_64530 project.
...
ROOT_URLCONF = 'fragrant_mud_dev_64530.urls'
...
WSGI_APPLICATION = 'fragrant_mud_dev_64530.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "fragrant_mud_dev_64530 API",
    "DESCRIPTION": "API documentation for fragrant_mud_dev_64530 App",
    "VERSION": "v1",
}
